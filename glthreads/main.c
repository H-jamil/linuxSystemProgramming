/**
 * @Author: jamil
 * @Date:   2021-05-01T15:21:07-05:00
 * @Last modified by:   jamil
 * @Last modified time: 2021-05-01T15:28:31-05:00
 */
...
main(int argc, char **argv){
    ...
    emp1->emp_id = 21;
    glthread_node_init((&emp1->glnode)); //address(&) is passed as
    //emp_t structure has a glthread_node_t as a object not as object pointer
