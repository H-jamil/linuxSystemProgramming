/**
 * @Author: jamil
 * @Date:   2021-03-13T19:45:24-06:00
 * @Last modified by:   jamil
 * @Last modified time: 2021-03-13T19:56:05-06:00
 */
...
# 622 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 691 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 714 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1172 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1192 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 1220 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/mach/i386/_structs.h" 3 4
...
# 365 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/resource.h" 3 4
struct rlimit {
 rlim_t rlim_cur;
 rlim_t rlim_max;
};
# 400 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/resource.h" 3 4
struct proc_rlimit_control_wakeupmon {
 uint32_t wm_flags;
 int32_t wm_rate;
};
# 445 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/resource.h" 3 4
...
# 261 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h" 2 3 4
...
# 309 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/stdlib.h" 3 4
...
# 12 "application.c" 2
 ...
 print_student_db(dll_t *student_db) {
     ...
     dll_node_t *node_ptr = ((void *)0);
     student_t *data = ((void *)0);

     { dll_node_t *_node_ptr = ((void *)0);
       node_ptr = student_db->head;
       for(; node_ptr!= ((void *)0); node_ptr = _node_ptr){ 
         if(!node_ptr)
            break;
 ...
 search_student_by_rollno(dll_t *student_db,
     ...
     if(!student_db || !student_db->head) return ((void *)0);
...
# 93 "application.c"
 ...
 main(int argc, char **argv){
     ...
     __builtin___strncpy_chk (student1->name, "Abhishek", strlen("Abhishek"), __builtin_object_size (student1->name, 2 > 1 ? 1 : 0));
     student1->age = 31;
     student1->weight = 75;
     student1->rollno = 800000;

     student_t *student2 = calloc(1, sizeof(student_t));
     __builtin___strncpy_chk (student2->name, "Joseph", strlen("Joseph"), __builtin_object_size (student2->name, 2 > 1 ? 1 : 0));
     student2->age = 41;
     student2->weight = 70;
     student2->rollno = 800400;

     student_t *student3 = calloc(1, sizeof(student_t));
     __builtin___strncpy_chk (student3->name, "Jack", strlen("Jack"), __builtin_object_size (student3->name, 2 > 1 ? 1 : 0));
     student3->age = 29;
     student3->weight = 55;
     student3->rollno = 800400;

     student_t *student4 = calloc(1, sizeof(student_t));
     __builtin___strncpy_chk (student3->name, "Abhishek", strlen("Abhishek"), __builtin_object_size (student3->name, 2 > 1 ? 1 : 0));
     student3->age = 29;
     student3->weight = 55;
